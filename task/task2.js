...
//validate data of task1  like, if error occure give validate false and if print success validate true 
...
class Personvalidate {
    ...
    validateDt() {
        ...
        this.validateducation();
        this.validatedegreeyear();
        this.validateskills();
        ...
        return {
            validate: this.errors.length === 0 ? true:false,
            errors: this.errors,
